    ...
    <div className='wrapper'>
      <div className='bio-container' id='about'>
        ...
        <p>
          ...
          engineering and the process of building things from scratch, taking
          pride in writting elegant, dry code. I am excited to apply the skills
          I've built as a developer in an environment where I can grow as a
